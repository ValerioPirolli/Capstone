...
public class ActorService {
    ...
    public List<Movies> getFilmsByActorName(String name) {
        Actors actor = ar.findByName(name)
                .orElseThrow(() -> new EntityNotFoundException("Actor not found with name: " + name));
